...
$("#dotarea_0 ").append("<img id='img_0' src='img/nori.png'>");
// $("#dotarea_0 ").append("<p id='work_0'>user interaction with technology </p>");
$("#dotarea_1 ").append("<img id='img_1' src='img/data.png'>");
$("#dotarea_2 ").append("<img id='img_2' src='img/soccer.png'>");
$("#dotarea_3 ").append("<img id='img_3' src='img/school.png'>");
$("#dotarea_4 ").append("<img id='img_4' src='img/mari.png'>");
$("#dotarea_5 ").append("<img id='img_5' src='img/42.png'>");
$("#dotarea_6 ").append("<img id='img_6' src='img/zyga.png'>");
$("#dotarea_7 ").append("<img id='img_7' src='img/graphic.png'>");

$(function() {
    $('#dotarea_0').hover(function() {
        $('#work_0').css('opacity', '1');
        $('#dot_0').css('width', '16px');
        $('#dot_0').css('height', '16px');
        $('#img_0').css('opacity', '1');
        $('#img_0').css('margin', '5%');
    }, function() {
        $('#work_0').css('opacity', '0');
        $('#dot_0').css('width', '14px');
        $('#dot_0').css('height', '14px');
        $('#img_0').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_1').hover(function() {
        ...
        $('#dot_1').css('width', '16px');
        $('#dot_1').css('height', '16px');
        $('#img_1').css('opacity', '1');
        $('#img_1').css('margin', '5%');
    }, function() {
        $('#work_1').css('opacity', '0');
        $('#dot_1').css('width', '14px');
        $('#dot_1').css('height', '14px');
        $('#img_1').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_2').hover(function() {
        ...
        $('#dot_2').css('width', '16px');
        $('#dot_2').css('height', '16px');
        $('#img_2').css('opacity', '1');
        $('#img_2').css('margin', '5%');
    }, function() {
        $('#work_2').css('opacity', '0');
        $('#dot_2').css('width', '14px');
        $('#dot_2').css('height', '14px');
        $('#img_2').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_3').hover(function() {
        ...
        $('#dot_3').css('width', '16px');
        $('#dot_3').css('height', '16px');
        $('#img_3').css('opacity', '1');
        $('#img_3').css('margin', '5%');
    }, function() {
        $('#work_3').css('opacity', '0');
        $('#dot_3').css('width', '14px');
        $('#dot_3').css('height', '14px');
        $('#img_3').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_4').hover(function() {
        ...
        $('#dot_4').css('width', '16px');
        $('#dot_4').css('height', '16px');
        $('#img_4').css('opacity', '1');
        $('#img_4').css('margin', '5%');
    }, function() {
        $('#work_4').css('opacity', '0');
        $('#dot_4').css('width', '14px');
        $('#dot_4').css('height', '14px');
        $('#img_4').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_5').hover(function() {
        ...
        $('#dot_5').css('width', '16px');
        $('#dot_5').css('height', '16px');
        $('#img_5').css('opacity', '1');
        $('#img_5').css('margin', '5%');
    }, function() {
        $('#work_5').css('opacity', '0');
        $('#dot_5').css('width', '14px');
        $('#dot_5').css('height', '14px');
        $('#img_5').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_6').hover(function() {
        ...
        $('#dot_6').css('width', '16px');
        $('#dot_6').css('height', '16px');
        $('#img_6').css('opacity', '1');
        $('#img_6').css('margin', '5%');
    }, function() {
        $('#work_6').css('opacity', '0');
        $('#dot_6').css('width', '14px');
        $('#dot_6').css('height', '14px');
        $('#img_6').css('opacity', '0');
    });
});
$(function() {
    $('#dotarea_7').hover(function() {
        ...
        $('#dot_7').css('width', '16px');
        $('#dot_7').css('height', '16px');
        $('#img_7').css('opacity', '1');
        $('#img_7').css('margin', '5%');
    }, function() {
        $('#work_7').css('opacity', '0');
        $('#dot_7').css('width', '14px');
        $('#dot_7').css('height', '14px');
        $('#img_7').css('opacity', '0');
    });
});
